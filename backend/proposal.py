...
class proposal:
    def get_proposal_info(self, proposal_ID):
        ...
        leaders_query = "SELECT CONCAT(F_Name, ' ', L_Name), Email AS Full_Name FROM STUDENT WHERE Proj_Interest = '{}' AND Role = 'Student_Leader'".format(proj_type)
    ...
    def approve_proposal(self, proposal_ID, leader_email):
        ...
        assign_leader_query = "UPDATE PROJECT SET Stu_Lead_ID = '{}'".format(leader_ID)
